...
router.post('/leave-feedback/confirmation', function(req, res) {
  ...
  var personalisation = {
    ...
    'answer9': questions.data[8].text + ": " + req.session.data["school-good-behaviour"] + " " + req.session.data["school-behaviour-explain"],
    'answer10': questions.data[9].text + ": " + req.session.data["my-child-bullied"] + " " + req.session.data["bullying-explain"],
...
router.post('/leave-feedback/confirmation-2', function(req, res) {
  ...
  var personalisation = {
    ...
    'answer9-2': questions.data[8].text + ": " + req.session.data["school-good-behaviour-2"] + " " + req.session.data["school-behaviour-explain-2"],
    'answer10-2': questions.data[9].text + ": " + req.session.data["my-child-bullied-2"] + " " + req.session.data["bullying-explain-2"],
